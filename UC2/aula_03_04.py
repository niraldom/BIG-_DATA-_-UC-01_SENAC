...
print(f"O município com maior quantidade de roubos é {maior_municipio_roubos.values[0]}")
print(f"O município com menor quantidade de roubos é {menor_municipio_roubos.values[0]}")
print(f"O município com maior valor populacional é {maior_municipio_populacao.values[0]}")
print(f"O município com menor valor populacional é {menor_municipio_populacao.values[0]}")
print("\n---- Taxa de Roubos ----")
print(df_ocorrencias['Município'] + "  " + tx_roubo)